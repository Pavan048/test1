...
const Solutions = () => {
    return (
        <Section
            id="solutions"
            title="Engineering Excellence Tailored to Your Business Goals"
            subtitle="We build advanced software solutions that solve real business problems and drive growth."
        >
